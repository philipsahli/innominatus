      ...
      {expanded && (
        <div className="px-4 py-3 bg-zinc-50 dark:bg-zinc-900/20 border-t border-zinc-200 dark:border-zinc-800">
          ...
          <div className="grid grid-cols-3 gap-4 text-xs mb-4">
            <div>
              <div className="text-zinc-500 dark:text-zinc-400 mb-1">Workflow ID</div>
              <div className="text-zinc-900 dark:text-white font-mono">{workflow.id}</div>
            </div>
            ...
            <div>
              <div className="text-zinc-500 dark:text-zinc-400 mb-1">Duration</div>
              <div className="text-zinc-900 dark:text-white">{workflow.duration || 'N/A'}</div>
            </div>
          ...
          {loadingSteps ? (
            ...
            <div className="space-y-2">
              {steps.map((step) => (
                <div
                  key={step.id}
                  className="bg-white dark:bg-zinc-900 rounded border border-zinc-200 dark:border-zinc-800 p-3"
                >
                  ...
                  {step.error_message && (
                    <div className="mt-2 text-red-600 dark:text-red-400 font-mono text-xs bg-red-50 dark:bg-red-500/5 p-2 rounded border border-red-200 dark:border-red-500/20">
                      {step.error_message}
                    </div>
                  )}
                </div>
  ...
  return (
    <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden">
      ...
      <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/30">
        <div className="grid grid-cols-5 gap-4 text-xs font-medium text-zinc-600 dark:text-zinc-400 uppercase tracking-wide">
