...
export default function ResourceGraphPage() {
  ...
  } = useResourceGraph(selectedApp || null);
            ...
            <CardContent>
              {selectedNode ? (
                  ...
                  {displayData && (
                    <div className="pt-4 border-t">
                      ...
                      <div className="text-sm space-y-1">
                        <p>
                          <strong>Application:</strong> {displayData.app_name}
                        </p>
                        <p>
                          <strong>Total Nodes:</strong> {displayData.nodes.length}
                        </p>
                        <p>
                          <strong>Total Edges:</strong> {displayData.edges.length}
                        </p>
                        <p>
                ...
                <div className="text-center text-muted-foreground py-8">
                  {selectedApp
                    ? 'Click on a node in the graph to see details here'
                    : 'Select an application to view resource details and manifest'}
                </div>
              )}
            </CardContent>
          </Card>
